...
import com.eclair.myfitnessgoal.database.AllFoodsEntity
...
class SearchFoodItemsViewHolder(private val view: View) : RecyclerView.ViewHolder(view) {
    ...
    fun setData(allFoodsEntity: AllFoodsEntity) {
        view.apply {
            tvFoodNameAll.text = allFoodsEntity.header
            tvNameAndWt.text = allFoodsEntity.Itemname
